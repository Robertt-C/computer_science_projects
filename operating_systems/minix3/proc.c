 ...
 */
   ...
   */
	...
	// Faz-se contagem de processos prontos em cada fila menos IDLE e guarda
	// cada valor em rdy_procs
	...
	// Conta-se o numero maximo de tickets
	...
	// Percorre-se as filas atraz da fila que contém o bilhete sorteado e 
	// encontra-se o bilhete sorteado por meio de somas da quantidade de bilhetes
	// que cada processo recebe segundo sua fila de prioridade
	int tickets_sum = 0;
